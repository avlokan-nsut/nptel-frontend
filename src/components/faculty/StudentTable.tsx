...
const StudentTable = function () {
    ...
    const handleSelectAll = () => {
        if (
            ...
            (apiData?.enrolled_students?.length || 0)
        ) {
            ...
            setSelectedStudents(
                apiData?.enrolled_students.map((student) => student.id) || []
            );
        }
    };
    ...
    const handleSubmit = async () => {
        ...
        const response = await axios
            .post(`${apiUrl}/teacher/students/request`, formattedData, {
                            ...
                            <div className="overflow-x-auto">
                                <table className="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200">
                                        {apiData?.enrolled_students &&
                                        apiData.enrolled_students.length > 0 ? (
                                            apiData.enrolled_students.map(
                                                (student) => (
                                                    <tr
                                                        key={student.id}
